...
int main() {
    int D_MAX = 100;
    Transaccion transaccion[] = {COMPRA, COMPRA, COMPRA, VENTA, COMPRA, VENTA, COMPRA, COMPRA, VENTA, VENTA, COMPRA, VENTA};
